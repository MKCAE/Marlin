...
#define STRING_CONFIG_H_AUTHOR "(Tevo Flash, My)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.058, 80.058, 399.2901, 985.62 }
